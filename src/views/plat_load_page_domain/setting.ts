...
import cmd_admin_plat_load_page_domain_uploadTemplate from "@/views/plat_load_page_domain/command/cmd_admin_plat_load_page_domain_uploadTemplate";
/**协议*/
export var HttpType = {
    ...
    admin_plat_load_page_domain_uploadTemplate: "admin/plat_load_page_domain/uploadTemplate/{id}",
};
/**事件*/
export var EventType = {
    ...
    admin_plat_load_page_domain_uploadTemplate: "admin_plat_load_page_domain_uploadTemplate",
};
/**注册协议*/
...
facade.registerCommand(HttpType.admin_plat_load_page_domain_uploadTemplate, cmd_admin_plat_load_page_domain_uploadTemplate);
