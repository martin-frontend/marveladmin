...
import PlatUserStatisticDaysProxy from "@/views/plat_user_statistic_days/proxy/PlatUserStatisticDaysProxy";
...
@Component
export default class PlatUserStatisticDaysDialog extends AbstractView {
    LangUtil = LangUtil;
    // 权限标识
    unique = unique;
