...
import { HttpType } from "@/views/vip_replenish_recharge_order/setting";
import { MessageBox } from "element-ui";
import IVipReplenishRechargeOrderProxy from "./IVipReplenishRechargeOrderProxy";
import GlobalEventType from "@/core/global/GlobalEventType";
import router from "@/router";
import { BaseInfo } from "@/components/vo/commonVo";

export default class VipReplenishRechargeOrderProxy extends AbstractProxy implements IVipReplenishRechargeOrderProxy {
    static NAME = "VipReplenishRechargeOrderProxy";

    /**进入页面时调用 */
    enter() {
        this.sendNotification(HttpType.admin_vip_replenish_recharge_order_table_columns);
    }
    ...
    /**查询 */
    onQuery() {
        this.sendNotification(HttpType.admin_vip_replenish_recharge_order_index, objectRemoveNull(this.listQuery));
    }
    ...
    onQueryAll() {
        ...
        this.facade.sendNotification(HttpType.admin_vip_replenish_recharge_order_index, objectRemoveNull(queryCopy));
    }
