...
import { HttpType } from "@/views/block_transfer_in_order/setting";
import { MessageBox } from "element-ui";
import IBlockTransferInOrderProxy from "./IBlockTransferInOrderProxy";

export default class BlockTransferInOrderProxy extends AbstractProxy implements IBlockTransferInOrderProxy {
    static NAME = "BlockTransferInOrderProxy";

    /**进入页面时调用 */
    enter() {
        this.sendNotification(HttpType.admin_block_transfer_in_order_table_columns);
    }
    ...
    /**查询 */
    onQuery() {
        this.sendNotification(HttpType.admin_block_transfer_in_order_index, objectRemoveNull(this.listQuery));
    }
    /**添加数据 */
    // onAdd() {
    //     const formCopy: any = {
