 ...
 */
import cmd_admin_statistic_user_days_table_columns from "@/views/statistic_user_days/command/cmd_admin_statistic_user_days_table_columns";
import cmd_admin_statistic_user_days_index from "@/views/statistic_user_days/command/cmd_admin_statistic_user_days_index";
/**协议*/
export var HttpType = {
...
export var EventType = {
    admin_statistic_user_days_table_columns: "admin_statistic_user_days_table_columns",
    admin_statistic_user_days_index: "admin_statistic_user_days_index",
};
/**注册协议*/
