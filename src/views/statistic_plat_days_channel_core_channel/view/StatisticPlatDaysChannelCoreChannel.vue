...
import StatisticPlatDaysChannelCoreChannelMediator from "@/views/statistic_plat_days_channel_core_channel/mediator/StatisticPlatDaysChannelCoreChannelMediator";
