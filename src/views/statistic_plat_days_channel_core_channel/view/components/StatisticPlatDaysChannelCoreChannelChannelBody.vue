    ...
    <div>
        ...
        >
            ...
            <el-table-column :label="tableColumns.recharge.name" align="center" prop="recharge">
                <template slot-scope="{ row }">
                    <WinLossDisplay :amount="row.recharge" :isShowColor="false" />
                </template>
            </el-table-column>
            ...
            <el-table-column :label="tableColumns.net_rech.name" align="center" prop="net_rech">
                <template slot-scope="{ row }">
                    <WinLossDisplay :amount="row.net_rech" :isShowColor="false" />
                </template>
            </el-table-column>
