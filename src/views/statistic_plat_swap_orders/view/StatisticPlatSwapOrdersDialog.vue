...
import StatisticPlatSwapOrdersProxy from "@/views/statistic_plat_swap_orders/proxy/StatisticPlatSwapOrdersProxy";
...
@Component
export default class StatisticPlatSwapOrdersDialog extends AbstractView {
    // 权限标识
