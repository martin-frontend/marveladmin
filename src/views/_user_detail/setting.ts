...
import cmd_admin_plat_user_related_users_update_status from "@/views/_user_detail/command/cmd_admin_plat_user_related_users_update_status";
// --登入日志&login_record
...
// --Easybet&easybet
import cmd_admin_plat_user_update_user_level from "@/views/_user_detail/command/cmd_admin_plat_user_update_user_level";
/**协议*/
export var HttpType = {
    // --基本信息&user_info
    ...
    admin_plat_user_related_users_update_status: "admin/plat_user/related_users/update_status/{user_id} ",
    // --登入日志&login_record
    ...
    // --Easybet&easybet
    admin_plat_user_update_user_level: "admin/plat_user/update_user_level/{user_id} ",
};
/**事件*/
export var EventType = {
    ...
    admin_plat_user_related_users_update_status: "_admin_plat_user_related_users_update_status",
    // --登入日志&login_record
    ...
    // --Easybet&easybet
    admin_plat_user_update_user_level: "_admin_plat_user_update_user_level",
};
/**注册协议*/
...
facade.registerCommand(HttpType.admin_plat_user_related_users_update_status, cmd_admin_plat_user_related_users_update_status);
// --登入日志&login_record
...
// --Easybet&easybet
facade.registerCommand(HttpType.admin_plat_user_update_user_level, cmd_admin_plat_user_update_user_level);
