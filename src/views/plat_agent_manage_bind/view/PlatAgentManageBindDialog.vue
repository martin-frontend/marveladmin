...
import PlatAgentManageBindProxy from "@/views/plat_agent_manage_bind/proxy/PlatAgentManageBindProxy";
...
@Component
export default class PlatAgentManageBindDialog extends AbstractView {
    // 权限标识
