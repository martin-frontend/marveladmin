        ...
        <el-form ref="form" :model="form" label-width="160px" v-loading="net_status.loading">
            ...
            <el-form-item>
                ...
                <el-form-item
                    ...
                    label-width="130px"
                >
                    <el-input-number controls-position="right" :min="0" :max="100" v-model="form.exchange_fee_ratio">
                    </el-input-number>
                    <span style="margin-left: 10px">%</span>
                </el-form-item>
                <el-form-item
                    ...
                    label-width="130px"
                >
                    <el-input-number controls-position="right" :min="0" :max="100" v-model="form.recharge_fee_ratio">
                    </el-input-number>
                    <span style="margin-left: 10px">%</span>
                </el-form-item>
