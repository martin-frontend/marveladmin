<template>
    <div class="content plat_agent_bind">
        <PlatAgentBindHeader />
        <PlatAgentBindBody />
...
import PlatAgentBindHeader from "./PlatAgentBindHeader.vue";
import PlatAgentBindBody from "./PlatAgentBindBody.vue";
