...
export default class StatisticUserPromotionDaysIndexProxy extends AbstractProxy
    ...
    tableData = {
        columns: <any>{
            ...
            directly_activity_coin_get: { name: '活动任务', options: {}, tips: "玩家任务获得任务币数量" },
            directly_activity_gift_gold: { name: '活动赠送', options: {}, tips: "活动发送并且玩家已经获得，不包含活动币币" },
            directly_activity_gold_exchange: { name: '任务币转换', options: {}, tips: "玩家完成任务获得真钱的数量" },
            ...
            directly_mail_gift_gold: { name: '邮件赠送', options: {}, tips: "人工发送的邮件附件并且玩家“已领取”，不包含活动币" },
            ...
            group_activity_coin_get: { name: '活动任务', options: {}, tips: "玩家任务获得任务币数量" },
            group_activity_gift_gold: { name: '活动赠送', options: {}, tips: "活动发送并且玩家已经获得，不包含活动币币" },
            group_activity_gold_exchange: { name: '任务币转换', options: {}, tips: "玩家完成任务获得真钱的数量" },
            ...
            group_mail_gift_gold: { name: '邮件赠送', options: {}, tips: "人工发送的邮件附件并且玩家“已领取”，不包含活动币" },
            ...
            roup_all_mail_gift_gold: { name: '邮件赠送', options: {}, tips: "人工发送的邮件附件并且玩家“已领取”，不包含活动币" },
            group_all_activity_coin_get: { name: '活动任务', options: {}, tips: "玩家任务获得任务币数量" },
            group_all_activity_gift_gold: { name: '活动赠送', options: {}, tips: "活动发送并且玩家已经获得，不包含活动币币" },
            group_all_activity_gold_exchange: { name: '任务币转换', options: {}, tips: "玩家完成任务获得真钱的数量" },
