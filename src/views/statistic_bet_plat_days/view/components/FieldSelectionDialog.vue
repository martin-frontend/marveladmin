<template>
    ...
    >
        ...
        <el-checkbox-group v-model="myProxy.fieldSelectionData.fieldOptions" @change="handleCheckedFieldsChange">
            <el-row>
                <template v-for="key in myProxy.fieldSelectionData.baseData">
        ...
        <div class="group">
            ...
            <el-button
                :disabled="myProxy.fieldSelectionData.fieldOptions.length == 0"
                type="primary"
                class="item"
                size="mini"
                @click="handleSubmit"
...
export default class FieldSelectionDialog extends AbstractView {
    ...
    handleCheckAllChange(val: any) {
        this.myProxy.fieldSelectionData.fieldOptions = val ? this.fieldOptions : [];
