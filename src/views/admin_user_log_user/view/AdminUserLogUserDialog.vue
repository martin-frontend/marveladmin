...
import AdminUserLogUserProxy from "@/views/admin_user_log_user/proxy/AdminUserLogUserProxy";
...
export default class AdminUserLogUserDialog extends AbstractView {
    LangUtil = LangUtil;
    // 权限标识
    unique = unique;
