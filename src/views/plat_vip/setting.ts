/**
 * description: 平台VIP
 * document: http://18.166.154.73:8090/pages/viewpage.action?pageId=66161
 */
import cmd_admin_plat_table_columns from "@/views/plat_vip/command/cmd_admin_plat_table_columns";
import cmd_admin_plat_index from "@/views/plat_vip/command/cmd_admin_plat_index";
import cmd_admin_plat_show from "@/views/plat_vip/command/cmd_admin_plat_show";
import cmd_admin_plat_update from "@/views/plat_vip/command/cmd_admin_plat_update";
import cmd_admin_plat_users_vip_model_table_columns from "@/views/plat_vip/command/cmd_admin_plat_users_vip_model_table_columns";
import cmd_admin_plat_users_vip_model_show from "@/views/plat_vip/command/cmd_admin_plat_users_vip_model_show";
/**协议*/
export var HttpType = {
