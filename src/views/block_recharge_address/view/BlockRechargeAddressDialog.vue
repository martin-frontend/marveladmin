...
import BlockRechargeAddressProxy from "@/views/block_recharge_address/proxy/BlockRechargeAddressProxy";
...
@Component
export default class BlockRechargeAddressDialog extends AbstractView {
    // 权限标识
