...
import cmd_admin_plats_wallet_log_table_columns from "@/views/plats_wallet/command/cmd_admin_plats_wallet_log_table_columns";
import cmd_admin_plats_wallet_log_index from "@/views/plats_wallet/command/cmd_admin_plats_wallet_log_index";
/**协议*/
export var HttpType = {
